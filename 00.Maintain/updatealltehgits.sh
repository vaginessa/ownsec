...
cd /opt/ITSEC-Install-Scripts/00.Maintain/update-lists/PT2-update-lists/1.Deps_Update
./1.Package-Mgr-Lists_Install.sh
./2.Node-Npm-update.sh

cd /opt/ITSEC-Install-Scripts/00.Maintain/update-lists/PT2-update-lists/2.Firmware_Update/1.Wifi
./1.RTL_8812_update.sh
./1.RTL_8192_update.sh

cd /opt/ITSEC-Install-Scripts/00.Maintain/update-lists/PT3-update-lists
