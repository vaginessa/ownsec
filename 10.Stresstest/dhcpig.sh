...
mkdir -p /opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/dhcpig/kamorin
cd /opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/dhcpig/kamorin
git clone https://github.com/kamorin/DHCPig

GITREPOROOT=/opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/dhcpig/kamorin/DHCPig
EXECUTEABLE1=pig.py
EXECUTEABLE2=dhcPIG
