...
mkdir -p /opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/ufonet/epsylon
cd /opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/ufonet/epsylon
git clone https://github.com/epsylon/ufonet

GITREPOROOT=/opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/ufonet/epsylon/ufonet
EXECUTEABLE1=ufonet
...
echo '#!/bin/bash
cd /opt/ITSEC/2.Vulnerability-Analysis/4.Stresstest/ufonet/epsylon/ufonet
./ufonet "$@"' > ufonet.sh
